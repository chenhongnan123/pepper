export default {
  ...
  values: {
    ...
    maintenanceDashboard: 'mdi-hammer-wrench',
    ...
    rework: 'mdi-cog-refresh-outline',
    scrapreasons: 'mdi-trash-can-outline',
    scrap: 'mdi-trash-can-outline',
    ...
    curing: 'mdi-bandage',
    treadRolling: 'mdi-air-humidifier',
    tireBuilding: 'mdi-wrench-outline',
    manpowerLog: 'mdi-account-hard-hat',
    productionPlanningCamso: 'mdi-calendar-text-outline',
    customDashboard: 'mdi-monitor-dashboard',
  },
};

      ...
      <v-row
        ...
        >
          <v-card
            ...
            class="mt-2 ma-1 elevation-4 rounded-xl bluecard d-flex align-start no-scrollbar"
            @click="goDetail(item)"
          >
            <v-btn
              class="ml-2 mt-3 mr-1"
              icon
              small
              color="primary"
            >
              ...
              >
                ...
                >
                  ...
                  <div
                    ...
                    class="body-2 point no-scrollbar"
                  >
                    <img
                      :src="

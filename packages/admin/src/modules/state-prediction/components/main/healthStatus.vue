...
export default {
  ...
  computed: {
    ...
    statusList() {
      const list = [
        {
          status: this.$t('statePrediction.label.healthy'),
          statusCode: 1,
          icon: 'mdi-leaf',
        ...
        {
          status: this.$t('statePrediction.label.relativelyHealthy'),
          statusCode: 2,
          icon: 'mdi-check',
        ...
        {
          status: this.$t('statePrediction.label.subHealthy'),
          statusCode: 3,
          icon: 'mdi-minus',
        ...
        {
          status: this.$t('statePrediction.label.earlyWarning'),
          statusCode: 4,
        ...
        {
          status: this.$t('statePrediction.label.fault'),
          statusCode: 5,
          icon: 'mdi-close',
